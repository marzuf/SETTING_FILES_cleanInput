    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_mfs/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_mfs/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_mfs/ddlps_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_mfs/mfs_ID.Rdata"
