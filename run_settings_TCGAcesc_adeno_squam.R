    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAcesc_adeno_squam/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAcesc_adeno_squam/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAcesc_adeno_squam/adeno_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAcesc_adeno_squam/squam_ID.Rdata"
