    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_norm_gs/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_norm_gs/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_norm_gs/norm_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_norm_gs/gs_ID.Rdata"
