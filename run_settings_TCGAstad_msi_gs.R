    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_msi_gs/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_msi_gs/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_msi_gs/msi_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_msi_gs/gs_ID.Rdata"
