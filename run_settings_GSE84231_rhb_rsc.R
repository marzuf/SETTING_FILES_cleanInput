...
pipOutFold <- "OUTPUT_FOLDER/GSE84231_rhb_rsc"
...
sample1_file <- "/mnt/ed4/marie/other_datasets/GSE84231/05.09_prepData/rhb_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/other_datasets/GSE84231/05.09_prepData/rsc_ID.Rdata"
