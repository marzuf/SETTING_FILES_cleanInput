    ...
    # > file written: Sun, 09 Dec 2018 01:20:28 +0100 

    # in this file, settings that are specific for a run on a dataset

    # gives path to output folder
    pipOutFold <- "OUTPUT_FOLDER/TCGAthca_mut.RAS_mutBRAF"
    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAthca_mut.RAS_mutBRAF/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAthca_mut.RAS_mutBRAF/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAthca_mut.RAS_mutBRAF/mut.RAS_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAthca_mut.RAS_mutBRAF/mutBRAF_ID.Rdata"
