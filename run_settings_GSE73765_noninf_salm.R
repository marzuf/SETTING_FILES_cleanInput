...
pipOutFold <- "OUTPUT_FOLDER/GSE73765_noninf_salm"
...
sample1_file <- "/mnt/ed4/marie/other_datasets/GSE73765/04.09_prepData/noninf_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/other_datasets/GSE73765/04.09_prepData/salm_ID.Rdata"
