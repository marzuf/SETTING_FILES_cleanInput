    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_lms_mfs/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_lms_mfs/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_lms_mfs/lms_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_lms_mfs/mfs_ID.Rdata"
