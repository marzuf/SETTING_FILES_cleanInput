...
pipOutFold <- "OUTPUT_FOLDER/GSE71119_undiffSM_LMSM"
...
sample1_file <- "/mnt/ed4/marie/other_datasets/GSE71119/20.09_prepData/undiffSM_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/other_datasets/GSE71119/20.09_prepData/LMSM_ID.Rdata"
