...
pipOutFold <- "OUTPUT_FOLDER/GSE77509_ptt_tumor"
...
sample1_file <- "/mnt/ed4/marie/other_datasets/GSE77509/20.09_prepData/ptt_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/other_datasets/GSE77509/20.09_prepData/tumor_ID.Rdata"
