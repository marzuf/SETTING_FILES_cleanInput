    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_EBVpos_gs/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_EBVpos_gs/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_EBVpos_gs/EBVpos_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAstad_EBVpos_gs/gs_ID.Rdata"
