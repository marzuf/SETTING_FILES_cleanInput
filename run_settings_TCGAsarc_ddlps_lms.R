    ...
    rna_fpkmDT_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_lms/fpkmDT.Rdata"

    rnaseqDT_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_lms/rnaseqDT_v2.Rdata"
    my_sep <- "\t"
    ...
    sample1_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_lms/ddlps_ID.Rdata"
    sample2_file <- "/mnt/ed4/marie/other_datasets/TCGAsarc_ddlps_lms/lms_ID.Rdata"
