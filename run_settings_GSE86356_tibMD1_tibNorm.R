...
pipOutFold <- "OUTPUT_FOLDER/GSE86356_tibMD1_tibNorm"
...
sample1_file <- "/mnt/ed4/marie/other_datasets/GSE86356/20.09_prepData/tibMD1_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/other_datasets/GSE86356/20.09_prepData/tibNorm_ID.Rdata"
